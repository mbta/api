defmodule Model.Schedule do
  ...
  * `:secondary_route_ids` - Routes that this trip has been added to via [`multi_route_trips.txt`](https://github.com/mbta/gtfs-documentation/blob/master/reference/gtfs.md#multi_route_tripstxt)
