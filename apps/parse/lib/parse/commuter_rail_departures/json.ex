defmodule Parse.CommuterRailDepartures.JSON do
  ...
  def parse_entity(%{"trip_update" => %{"trip" => trip, "stop_time_update" => updates}}) do
    for update <- updates do
      prediction(update, trip)
    end
  end
  ...
  defp best_schedule_relationship(trip, update) do
