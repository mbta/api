defmodule ApiWeb.FacilityView do
  ...
  attributes([:name, :long_name, :short_name, :type, :properties, :latitude, :longitude])
  ...
  def attributes(%Model.Facility{} = facility, conn) do
    attrs = Map.take(facility, ~w(name long_name short_name type properties latitude longitude)a)
